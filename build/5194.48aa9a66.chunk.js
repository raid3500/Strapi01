"use strict";(self.webpackChunkproject_6_v_4_20_2=self.webpackChunkproject_6_v_4_20_2||[]).push([[5194],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(63891),p=s(94061),X=s(48653),f=s(83997),S=s(30893);const F=(0,_.default)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
